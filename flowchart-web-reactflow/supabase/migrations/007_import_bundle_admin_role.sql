-- M-3 follow-up: admin may import equipment bundles (align with canEditFlowchart)
-- Depends on: 005_import_equipment_bundle.sql, 006_admin_role_and_rpc.sql
...
comment on function public.import_equipment_bundle(jsonb) is
  'Editor or admin bulk import: equipment_codes → devices → units → modules → flow_documents. '
